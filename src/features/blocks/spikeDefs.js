...
export const BLOCK_DEFS = [
  ...
  { type: "move_for_steer", colour: COLORS.movement, message0: "%1 przemieszczaj kierownica %2 przez %3 %4",
    args0: [icon(IC_MOTOR, "ruch"), { type: "input_value", name: "STEER", check: "Number" }, { type: "input_value", name: "DUR", check: "Number" }, { type: "field_dropdown", name: "UNIT", options: UNITS }],
    tooltip: "Kierownica: 0 = prosto, dodatnia = w prawo, ujemna = w lewo (-100…100). W owalne pole można wpiąć zmienną lub wyrażenie.", ...stmt() },
  ...
  { type: "move_start_steer", colour: COLORS.movement, message0: "%1 rozpocznij ruch %2",
    args0: [icon(IC_MOTOR, "ruch"), { type: "input_value", name: "STEER", check: "Number" }],
    tooltip: "Kierownica: 0 = prosto, dodatnia = w prawo, ujemna = w lewo (-100…100). W owalne pole można wpiąć zmienną lub wyrażenie.", ...stmt() },
...
export const TOOLBOX = {
  ...
  contents: [
    ...
    { kind: "category", name: "Ruch", colour: COLORS.movement, contents: [
      blk("move_for_dir", { DUR: num(10) }), blk("move_for_steer", { STEER: num(0), DUR: num(10) }),
      blk("move_start_dir"), blk("move_start_steer", { STEER: num(0) }), blk("move_stop"),
